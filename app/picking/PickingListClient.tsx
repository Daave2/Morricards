...
export default function PickingListClient() {
    ...
    const isFirestoreMock = (firestore as any).isMock;
    const ordersCollectionRef = useMemoFirebase(
        () => (!isFirestoreMock && settings.locationId) ? collection(firestore, `stores/${settings.locationId}/pickingOrders`) : null,
        [firestore, settings.locationId, isFirestoreMock]
    );
